...
from smarthelio_shared.expected_inverter_parameter_stc import get_multiindex_expected_current_stc
from smarthelio_shared.expected_inverter_parameter_stc import get_multiindex_expected_voltage_stc
from smarthelio_shared.expected_inverter_parameter_stc import get_multiindex_expected_power_stc

from smarthelio_shared.expected_inverter_parameter_noct import get_multiindex_expected_current_noct
from smarthelio_shared.expected_inverter_parameter_noct import get_multiindex_expected_power_noct
from smarthelio_shared.expected_inverter_parameter_noct import get_multiindex_expected_voltage_noct


def get_expected_inverter_params_multiindex(array_info, inverter_df, meteo_df):
    """
